...
namespace Truta_Diana_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Truta_Diana_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Truta_Diana_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
